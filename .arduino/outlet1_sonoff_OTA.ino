...
Adafruit_MQTT_Publish status0 = Adafruit_MQTT_Publish(&mqtt, "/outlet/status/1/0"); //Plug 0

// Setup a feed called 'outlet' for subscribing to changes.
Adafruit_MQTT_Subscribe onoff0 = Adafruit_MQTT_Subscribe(&mqtt, "/outlet/1/0");
 ...
 */
  ...
  ArduinoOTA.setHostname("wifi-outlet-1");
